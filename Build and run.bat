...
type boot_sector.bin kernel.bin 15_sectors > os_image.bin
REM 15_sectors file is to make sure the kernel is at least 15 sectors because that is what is loaded in the bootstrap.
pause
